                    ...
                    <div class="card-body">
                        @admincan('emails_manager_create')
                            <div class="text-right">
                                <a href="{{ route('admin.emails.create') }}" class="btn btn-primary mb-3">Create New Email
                                    Template</a>
                            </div>
                        @endadmincan
                            ...
                            <table class="table">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col">@sortablelink('subject', 'Subject', [], ['class' => 'text-dark'])</th>
                                    ...
                                    @if (isset($emails) && $emails->count() > 0)
                                        ...
                                        @foreach ($emails as $email)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $email->created_at ? $email->created_at->format(config('GET.admin_date_time_format') ?? 'Y-m-d H:i:s') : '—' }}
                                                </td>
                                                <td style="width: 10%;">
